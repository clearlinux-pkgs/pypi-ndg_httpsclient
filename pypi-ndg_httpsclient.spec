...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707127683
...
cp %{_builddir}/ndg_httpsclient-%{version}/ndg/httpsclient/LICENSE %{buildroot}/usr/share/package-licenses/pypi-ndg_httpsclient/e0de95c235bf947465c907c614e8a522062efb1c || :
